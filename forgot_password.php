    ...
    <main class="bg-info bg-opacity-25 mt-3 mb-5">
        <div class="container">
            <div class="row ">
                ...
                <form class="col-md-6 col-12 mt-5" id="password_restore" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="row g-3 mt-2">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="mb-3 text-center" for="email"> נא למלא את המייל שאיתו נרשמת לאתר לצורך שחזור סיסמה <br><span class="warning text-danger d-none">כתובת האימייל אינה קיימת</span> </label>
