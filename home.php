...
<body class="main-body">
      ...
      <div class="modal-dialog" dir="rtl">
        <div class="modal-content" dir="rtl">
          ...
          <div class="modal-body bg-info bg-opacity-25">
            <form id="create-list-form" action="queries/create_list.php" method="post">
              <div class="mb-3">
  ...
  <script>
    $(function() {
      <?php
      require_once("queries/get_users.php");
